...
import { Image, MousePointer2, BarChart3 } from "lucide-react";
      ...
      <div className="bg-background-secondary border-b border-border-default px-4 py-2 flex items-center justify-between flex-shrink-0">
        ...
        <div className="flex items-center gap-2 truncate">
          ...
          <span className="text-sm font-bold text-foreground whitespace-nowrap">
            <span className="hidden sm:inline mr-1 text-muted-foreground font-medium">Lấp đầy:</span>
            {fillRate}%
          </span>
      ...
      <div className="relative h-[250px] sm:h-[300px] shrink-0 lg:flex-1 lg:h-auto lg:min-h-0 bg-background-secondary flex flex-col">
        ...
        <div className="absolute top-4 right-4 z-10">
          <button
            ...
            `}
            title={isInteractiveMode ? "Chuyển về chế độ xem tĩnh" : "Chuyển sang chế độ tương tác 3D"}
          >
            {isInteractiveMode ? (
